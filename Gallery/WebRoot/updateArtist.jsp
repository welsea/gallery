...
<!--return-->
	<div style="margin: 30px">
		<div style="margin: auto;width:90%">
	        <h2 style="font-size:20px;font-family: Georgia;margin-left: 10px ">修改信息</h2>
	        <hr>
	...
	<div class="container" style="width:40%;margin:auto">
	 <form action="UpdateAServlet">
	 	<div class="form-group">
	      ...
	      <input type="text" class="form-control" name="id" placeholder="" value="<%=artist.getId()%>">
	    </div>
	    <div class="form-group">
	      <label for="text">中文名</label>
	      <input type="text" class="form-control" name="name_cn" placeholder="" value="<%=artist.getName_cn()%>">
	    </div>
	    <div class="form-group">
	      <label for="text">外文名</label>
	      <input type="text" class="form-control" name="name_en" placeholder="" value="<%=artist.getName_en()%>">
	    </div>
	    <div class="form-group">
	      <label for="text">诞生日期</label>
	      <input type="text" class="form-control" name="born" placeholder="" value="<%=artist.getBorn()%>">
	    </div>
	    <div class="form-group">
	      <label for="text">逝世日期</label>
	      <input type="text" class="form-control" name="died" placeholder="" value="<%=artist.getDied()%>">
	    </div>
	    <div class="form-group">
	      <label for="text">国籍</label>
	      <input type="text" class="form-control" name="nationality" placeholder="" value="<%=artist.getNationality()%>">
	    </div>
	    <div class="form-group">
	      <label for="text">著名作品</label>
	      <input type="text" class="form-control" name="notable_work" placeholder="" value="<%=artist.getNotableWork()%>">
	    </div>
	    <div class="form-group">
	      <label for="text">img</label>
	      <input type="text" class="form-control" id="img" placeholder="" value="<%=artist.getImg()%>">
	    </div>
