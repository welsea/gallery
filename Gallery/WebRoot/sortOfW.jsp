	...
	<div>
	    <div style="margin: auto;width: 80%">
	        <div style="margin: 15px;">
	            <h2 style="font-size:20px;font-family: Georgia;margin-left: 10px ">按照作品名排序</h2>
	            <hr>
	        </div>
	      <%
for(A_work work:list){
	    	if(work.getName_en()!=null){
 %>
 		<div style="margin: 15px;width:90%">
			<a href="work_info.jsp?id=<%=work.getWId() %>" ><%= work.getName_cn() %></a><br>
		</div>
<%
	    }else{
	    	continue;
