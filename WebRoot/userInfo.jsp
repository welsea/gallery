...
<body>
<%
String f_username=request.getParameter("id");
User user=new User();
List<usrShare> list=user.getUShareList(f_username);
 %>
...
<!--return-->
	<div style="margin: 30px">
		<div style="margin: auto;width:90%">
	        <h2 style="font-size:20px;font-family: Georgia;margin-left: 10px "><%=f_username%>的分享</h2>
	        <hr>
	    </div>	
	</div>
	...
	<%
		for(usrShare share:list){
			if(share.getImg()!=null){
	%>
	 	
		  <div class="card">
		    <img class="card-img-top" data-src="holder.js/100%x160/" alt="Card image cap" src="http://localhost:8080/Ggllery/images/<%=share.getImg()%>">
		    <div class="card-block">
		      <p class="card-text"><%=share.getIntro()%>  
			  <p class="card-text"><small class="text-muted"><a href="userInfo.jsp?id=<%=share.getUsername()%>"><%=share.getUsername() %></a></small></p>
		    </div>
		  </div>
		  <%}else{ %>
		  <div class="card">
