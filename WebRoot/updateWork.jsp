	...
	<div class="container" style="width:40%;margin:auto">
	 <form action="UpdateServlet">
	 	<div class="form-group">
	      ...
	      <input type="text" class="form-control" name="id" placeholder="" value="<%=work.getWId()%>">
	    </div>
	    <div class="form-group">
	      <label for="text">作品名（中）</label>
	      <input type="text" class="form-control" name="name_cn" placeholder="" value="<%=work.getName_cn() %>">
	    </div>
	    <div class="form-group">
	      <label for="text">作品名（英）</label>
	      <input type="text" class="form-control" name="name_en" placeholder="" value="<%=work.getName_en() %>">
	    </div>
	    <div class="form-group">
	      <label for="text">艺术家</label>
	      <input type="text" class="form-control" name="artist" placeholder="" value="<%=artist.getName_cn() %>">
	    </div>
	    <div class="form-group">
	      <label for="text">年代</label>
	      <input type="text" class="form-control" name="w_date" placeholder="" value="<%=work.getW_date() %>">
	    </div>
	    <div class="form-group">
	      <label for="text">现藏于</label>
	      <input type="text" class="form-control" name="w_location" placeholder="" value="<%=work.getW_location() %>">
	    </div>
	    <div class="form-group">
	      <label for="text">img</label>
	      <input type="text" class="form-control" name="img" placeholder="" value="<%=work.getImg() %>">
	    </div>
